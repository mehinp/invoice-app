package com.mehin.invoiceapp.query;
...
public class UserQuery {
    ...
    public static final String INSERT_VERIFICATION_CODE_QUERY = "INSERT INTO TwoFactorVerifications (user_id, code, expirationDate) VALUES (:userId, :code, :expirationDate)";
    ...
    public static final String UPDATE_USER_DETAILS_QUERY = "UPDATE Users SET first_name = :firstName, last_name = :lastName, email = :email," +
