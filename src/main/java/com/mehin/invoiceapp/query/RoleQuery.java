...
public class RoleQuery {
    ...
    public static final String SELECT_ROLES_QUERY = "SELECT * FROM Roles ORDER BY id ASC";
    public static final String UPDATE_USER_ROLE_BY_ID_QUERY = "UPDATE UserRoles SET role_id = (SELECT id FROM Roles WHERE name = :roleName) WHERE user_id = :userId";
}
